...
class OlympicWinnersService {
    ...
    getData(request, resultsCallback) {
        ...
        client.query(query, (err, results) => {
            ...
            const rowCount = this.getRowCount(request, results.rows);
    ...
    buildSql(request) {
        ...
        const fromSql = ' FROM systemx.olympic_winners ';
    ...
    getRowCount(request, results) {
        ...
        let returnValue = currentLastRow <= request.endRow ? currentLastRow : -1;
